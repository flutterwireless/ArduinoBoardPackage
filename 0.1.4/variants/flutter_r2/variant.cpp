...
extern const PinDescription g_APinDescription[]=
{
  ...
  // ----------------------
  // 0/1 - TWI0
  { PIOA, PIO_PA3A_TWD0,    ID_PIOA, PIO_PERIPH_A, PIO_PULLUP, PIN_ATTR_DIGITAL,            NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // D0 TWD0 - SDA1
  { PIOA, PIO_PA4A_TWCK0,   ID_PIOA, PIO_PERIPH_A, PIO_PULLUP, PIN_ATTR_DIGITAL,            NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // D1 TWCK0 - SCL1
  // 2/3 - UART (Serial)
  ...
  { PIOA, PIO_PA16,    ID_PIOA, PIO_PERIPH_C, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),        NO_ADC, NO_ADC, PWM_CH2,  NOT_ON_TIMER }, // D14 S3 RGB_G

  { PIOA, PIO_PA15,    ID_PIOA, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_DIGITAL,                    NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },  // D15 S4 (Radio GPIO0)
  { PIOA, PIO_PA11A_NPCS0, ID_PIOA, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_DIGITAL,                NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },  // D16 S5 (Radio GPIO3)
...
USARTClass Serial(USART0, USART0_IRQn, ID_USART0, &rx_buffer1);
